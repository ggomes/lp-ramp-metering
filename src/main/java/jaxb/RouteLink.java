 ...
 *       &lt;attribute name="link_order" use="required" type="{http://www.w3.org/2001/XMLSchema}int" />
...
@XmlType(name = "")
@XmlRootElement(name = "route_link")
public class RouteLink {
    ...
    @XmlAttribute(name = "link_order", required = true)
     ...
     * 
     */
    public void setLinkOrder(int value) {
